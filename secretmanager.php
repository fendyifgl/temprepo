<?php
    ...
    $secretNameDB = @$_POST['sndb'] ? @$_POST['sndb'] : 'arn:aws:secretsmanager:ap-southeast-3:402663288391:secret:prd/legacy/glindo-SYulQt';
    $secretNameFTP = @$_POST['snftp'] ? @$_POST['snftp'] : 'arn:aws:secretsmanager:ap-southeast-3:402663288391:secret:prd/legacy/ftpglindo-KQMeE0';
