<?php
  ...
  while (oci_fetch($documentCreated)) {
    $pdf->Cell(200,10,'Created Date : ' . oci_result($documentCreated, 'DATETIME') ,0,0);
    $pdf->Ln(7);
    $pdf->Cell(200,10,'Created By : ' . oci_result($documentCreated, 'USR') ,0,0);
    $pdf->Ln(7);
  ...
  // DOCUMENT CREATED
    ...
    $pdf->Cell(55, 5, oci_result($documentCreated, 'ACTIVITY'), 0, 0);
    $pdf->Ln(7);
    $pdf->Cell(25, 5, oci_result($documentCreated, 'DATETIME'), 0, 1);
  ...
  while (oci_fetch($documentViewed)) {
    ...
    $pdf->Cell(55, 5, oci_result($documentViewed, 'ACTIVITY') . " by " . oci_result($documentViewed, 'USR'), 0, 0);
    $pdf->Ln(7);
    $pdf->Cell(25, 5, oci_result($documentViewed, 'DATETIME'), 0, 1);
  ...
  while (oci_fetch($documentOTP)) {
    ...
    $pdf->Cell(55, 5, oci_result($documentOTP, 'ACTIVITY') . " code sent to " . oci_result($documentOTP, 'USR') . " via SMS", 0, 0);
    $pdf->Ln(7);
    $pdf->Cell(25, 5, oci_result($documentOTP, 'DATETIME'), 0, 1);
  ...
  while (($row = oci_fetch_array($documentSigned, OCI_BOTH)) != false) { 
    ...
    $pdf->Cell(55, 5, oci_result($documentSigned, 'ACTIVITY') . " by " . oci_result($documentSigned, 'USR'), 0, 0);
    $pdf->Ln(7);
    $pdf->Cell(25, 5, oci_result($documentSigned, 'DATETIME'), 0, 1);
  ...
  while (oci_fetch($documentAgreement)) {
    ...
    $pdf->Cell(55, 5, oci_result($documentAgreement, 'ACTIVITY') . " by " . oci_result($documentAgreement, 'USR'), 0, 0);
    $pdf->Ln(7);
    $pdf->Cell(25, 5, oci_result($documentAgreement, 'DATETIME'), 0, 1);
