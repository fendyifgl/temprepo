...
class Pkajonline extends CI_Controller {
    ...
    function term_pkajonline() {
        ...
        $this->Pkaj_model->insert_history_sign('Document viewed', $this->input->get('name'), $this->input->get('iduser'), $this->input->get('nopkaj'), 'PDF', 'TESTING');
            ...
            if($result>0){
                foreach ($result as $key => $value) {
                    ...
                    if($nopkaj){
                        ...
                        $this->Pkaj_model->insert_history_sign('Otp', $this->input->get('name'), $this->input->get('iduser'), $this->input->get('nopkaj'), 'PDF', 'TESTING');
                    }              
                }
    ...
    function insert_pkajonline() {
        ...
        foreach($data as $i => $d) { 
            ...
            $this->Pkaj_model->insert_history_sign('Document signed', $namabm, $this->input->get('iduser'), $nopkaj, 'PDF', 'TESTING');
        ...
        $this->Pkaj_model->insert_history_sign('Agreement completed', $namaklien, $this->input->get('iduser'), $nopkaj, 'PDF', 'TESTING');
